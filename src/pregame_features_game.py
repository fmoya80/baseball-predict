...
def prepare_starter_history(starter_df: pd.DataFrame) -> pd.DataFrame:
    ...
    starter_cols = [
        ...
        "starter_season_outs",
        "starter_season_innings",
        "starter_season_hits_allowed",
        "starter_season_earned_runs",
        "starter_season_walks",
        "starter_season_strikeouts",
        "starter_season_home_runs_allowed",
        "starter_season_era",
    ]
...
def prepare_batting_history(batting_df: pd.DataFrame) -> pd.DataFrame:
    ...
    batting_cols = [
        ...
        "total_bases_last_10_avg",
        "total_bases_season_to_date",
        "avg_game_last_3_avg",
        "avg_game_last_5_avg",
        "avg_game_last_10_avg",
        "AVG_last_10",
        "avg_game_season_to_date",
        "obp_game_last_3_avg",
        "obp_game_last_5_avg",
        "obp_game_last_10_avg",
        "OBP_last_10",
        "obp_game_season_to_date",
        "slg_game_last_3_avg",
        "slg_game_last_5_avg",
        "slg_game_last_10_avg",
        "SLG_last_10",
        "slg_game_season_to_date",
        "ops_game_last_3_avg",
        "ops_game_last_5_avg",
        "ops_game_last_10_avg",
        "OPS_last_10",
        "ops_game_season_to_date",
        "iso_game_last_3_avg",
        "iso_game_last_5_avg",
        "iso_game_last_10_avg",
        "ISO_last_10",
...
def build_offense_snapshot_for_side(
    ...
    rename_map = {
        ...
        "games_played_last_10": f"{side}_offense_games_played_last_10",
        ...
        "runs_scored_last_10_avg": f"{side}_offense_runs_scored_last_10_avg",
        ...
        "hits_last_10_avg": f"{side}_offense_hits_last_10_avg",
        "hits_last_10": f"{side}_offense_hits_last_10",
        ...
        "at_bats_last_10_avg": f"{side}_offense_at_bats_last_10_avg",
        ...
        "home_runs_last_10_avg": f"{side}_offense_home_runs_last_10_avg",
        "home_runs_last_10": f"{side}_offense_home_runs_last_10",
        "walks_last_3_avg": f"{side}_offense_walks_last_3_avg",
        "walks_last_5_avg": f"{side}_offense_walks_last_5_avg",
        "walks_last_10_avg": f"{side}_offense_walks_last_10_avg",
        "walks_last_10": f"{side}_offense_walks_last_10",
        ...
        "strikeouts_last_10_avg": f"{side}_offense_strikeouts_last_10_avg",
        "strikeouts_last_10": f"{side}_offense_strikeouts_last_10",
        "singles_last_3_avg": f"{side}_offense_singles_last_3_avg",
        "singles_last_5_avg": f"{side}_offense_singles_last_5_avg",
        "singles_last_10_avg": f"{side}_offense_singles_last_10_avg",
        ...
        "total_bases_last_10_avg": f"{side}_offense_total_bases_last_10_avg",
        ...
        "avg_game_last_10_avg": f"{side}_offense_avg_game_last_10_avg",
        "AVG_last_10": f"{side}_offense_AVG_last_10",
        ...
        "obp_game_last_10_avg": f"{side}_offense_obp_game_last_10_avg",
        "OBP_last_10": f"{side}_offense_OBP_last_10",
        ...
        "slg_game_last_10_avg": f"{side}_offense_slg_game_last_10_avg",
        "SLG_last_10": f"{side}_offense_SLG_last_10",
        ...
        "ops_game_last_10_avg": f"{side}_offense_ops_game_last_10_avg",
        "OPS_last_10": f"{side}_offense_OPS_last_10",
        ...
        "iso_game_last_10_avg": f"{side}_offense_iso_game_last_10_avg",
        "ISO_last_10": f"{side}_offense_ISO_last_10",
